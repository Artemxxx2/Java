...
public class CordovaBridge {
  ...
  public String jsExec(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4) throws JSONException, IllegalAccessException {
  ...
  public String jsRetrieveJsMessages(int paramInt, boolean paramBoolean) throws IllegalAccessException {
    return !verifySecret("retrieveJsMessages()", paramInt) ? null : this.jsMessageQueue.popAndEncode(paramBoolean);
  }
  
  public void jsSetNativeToJsBridgeMode(int paramInt1, int paramInt2) throws IllegalAccessException {
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\org\apache\cordova\CordovaBridge.class
