...
public class CordovaWebViewImpl implements CordovaWebView {
  ...
  private void sendJavascriptEvent(String paramString) {
    ...
    coreAndroid.fireJavascriptEvent(paramString);
  }
      ...
      if (CordovaWebViewImpl.this.engine.getView().getVisibility() != 0)
        (new Thread(new Runnable() {
              public void run() {
                try {
                  Thread.sleep(2000L);
                  Activity activity = CordovaWebViewImpl.this.cordova.getActivity();
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\org\apache\cordova\CordovaWebViewImpl.class
