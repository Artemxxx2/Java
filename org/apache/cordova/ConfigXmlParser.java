...
public class ConfigXmlParser {
  ...
  public void handleStartTag(XmlPullParser paramXmlPullParser) {
    ...
    } else if (this.insideFeature && str.equals("param")) {
  ...
  public void parse(Context paramContext) {
    ...
    parse((XmlPullParser)paramContext.getResources().getXml(j));
  }
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\org\apache\cordova\ConfigXmlParser.class
