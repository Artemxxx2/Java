...
class null implements FileUtils.FileOp {
  public void run(JSONArray paramJSONArray) throws FileExistsException, IOException, TypeMismatchException, EncodingException, JSONException {
    ...
    if (bool && FileUtils.access$100(FileUtils.this, str3, 3)) {
      FileUtils.access$200(FileUtils.this, rawArgs, 0, callbackContext);
    } else if (!bool && FileUtils.access$100(FileUtils.this, str3, 4)) {
      FileUtils.access$900(FileUtils.this, rawArgs, 0, callbackContext);
    } else {
      JSONObject jSONObject = FileUtils.access$1000(FileUtils.this, str1, str2, paramJSONArray.optJSONObject(2), false);
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\org\apache\cordova\file\FileUtils$18.class
