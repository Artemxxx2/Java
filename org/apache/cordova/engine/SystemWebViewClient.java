...
public class SystemWebViewClient extends WebViewClient {
  ...
  private static boolean needsSpecialsInAssetUrlFix(Uri paramUri) {
    return (CordovaResourceApi.getUriType(paramUri) != 1) ? false : ((paramUri.getQuery() != null || paramUri.getFragment() != null) ? true : (!paramUri.toString().contains("%") ? false : false));
  }
  ...
  public AuthenticationToken getAuthenticationToken(String paramString1, String paramString2) {
    AuthenticationToken authenticationToken1 = this.authenticationTokens.get(paramString1.concat(paramString2));
    AuthenticationToken authenticationToken2 = authenticationToken1;
    if (authenticationToken1 == null) {
      AuthenticationToken authenticationToken = this.authenticationTokens.get(paramString1);
      if (authenticationToken == null)
        authenticationToken = this.authenticationTokens.get(paramString2); 
      authenticationToken2 = authenticationToken;
      if (authenticationToken == null)
        authenticationToken2 = this.authenticationTokens.get(""); 
    } 
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\org\apache\cordova\engine\SystemWebViewClient.class
