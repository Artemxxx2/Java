...
final class BackStackState implements Parcelable {
  ...
  public BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl) {
    ...
    while (i < this.mOps.length) {
      ...
      i = k + 1;
      op.popEnterAnim = arrayOfInt[k];
      op.popExitAnim = arrayOfInt[i];
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\fragment\app\BackStackState.class
