...
public class SimpleArrayMap<K, V> {
  ...
  private void allocArrays(int paramInt) {
    ...
    //   59: ldc androidx/collection/ArrayMap
    //   61: monitorexit
    //   62: return
    //   63: ldc androidx/collection/ArrayMap
    //   65: monitorexit
    //   66: goto -> 149
    //   69: astore_2
    //   70: ldc androidx/collection/ArrayMap
    //   72: monitorexit
    //   73: aload_2
    //   74: athrow
    //   75: iload_1
    //   76: iconst_4
    //   77: if_icmpne -> 149
    //   80: ldc androidx/collection/ArrayMap
    //   82: monitorenter
    ...
    //   133: ldc androidx/collection/ArrayMap
    //   135: monitorexit
    //   136: return
    //   137: ldc androidx/collection/ArrayMap
    //   139: monitorexit
    //   140: goto -> 149
    //   143: astore_2
    //   144: ldc androidx/collection/ArrayMap
    //   146: monitorexit
    //   147: aload_2
    //   148: athrow
    //   149: aload_0
  ...
  private static void freeArrays(int[] paramArrayOfint, Object[] paramArrayOfObject, int paramInt) {
    ...
    //   61: ldc androidx/collection/ArrayMap
    //   63: monitorexit
    //   64: goto -> 145
    //   67: astore_0
    //   68: ldc androidx/collection/ArrayMap
    //   70: monitorexit
    //   71: aload_0
    //   72: athrow
    //   73: aload_0
    ...
    //   75: iconst_4
    //   76: if_icmpne -> 145
    //   79: ldc androidx/collection/ArrayMap
    //   81: monitorenter
    ...
    //   136: goto -> 145
    //   139: astore_0
    //   140: ldc androidx/collection/ArrayMap
    //   142: monitorexit
    //   143: aload_0
    //   144: athrow
    //   145: return
    ...
    if (paramObject instanceof SimpleArrayMap) {
      ...
      try {
        while (b < this.mSize) {
          paramObject = keyAt(b);
          V v = valueAt(b);
          Object object = simpleArrayMap.get(paramObject);
          if (v == null) {
            if (object != null || !simpleArrayMap.containsKey(paramObject))
              return false; 
          } else {
    ...
    if (classCastException instanceof Map) {
      ...
      try {
        while (b < this.mSize) {
          K k = keyAt(b);
          V v = valueAt(b);
          classCastException = (ClassCastException)map.get(k);
          if (v == null) {
            if (classCastException != null || !map.containsKey(k))
              return false; 
          } else {
            boolean bool = v.equals(classCastException);
            if (!bool)
              return false; 
          } 
          b++;
  ...
  public int hashCode() {
    ...
    byte b = 0;
    int j = 0;
    for (boolean bool = true; b < i; bool += true) {
      int m;
  ...
  public V put(K paramK, V paramV) {
    ...
    if (i >= this.mHashes.length) {
      ...
      if (i == this.mSize) {
        ...
        freeArrays(arrayOfInt, arrayOfObject1, i);
      } else {
        throw new ConcurrentModificationException();
      } 
    } 
    if (m < i) {
      ...
      Object[] arrayOfObject1 = this.mArray;
      System.arraycopy(arrayOfObject1, m << 1, arrayOfObject1, j << 1, this.mSize - m << 1);
    } 
    int j = this.mSize;
    if (i == j) {
      int[] arrayOfInt = this.mHashes;
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\collection\SimpleArrayMap.class
