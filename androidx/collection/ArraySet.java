    ...
    if (i <= 1) {
      ...
      if (j > 8 && i < arrayOfInt.length / 3) {
        ...
        if (paramInt < i) {
          ...
          Object[] arrayOfObject1 = this.mArray;
          System.arraycopy(arrayOfObject1, k, arrayOfObject1, paramInt, this.mSize - paramInt);
        } 
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\collection\ArraySet.class
