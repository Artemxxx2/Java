    ...
    while (true) {
      ...
      synchronized (this.mReceivers) {
        ...
        for (i = 0; i < arrayOfBroadcastRecord.length; i++) {
          BroadcastRecord broadcastRecord = arrayOfBroadcastRecord[i];
          int j = broadcastRecord.receivers.size();
          for (byte b = 0; b < j; b++) {
            receiverRecord = broadcastRecord.receivers.get(b);
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\localbroadcastmanager\content\LocalBroadcastManager.class
