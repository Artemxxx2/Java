...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
  ...
  public TypefaceCompatApi26Impl() {
    ...
    try {
      ...
      stringBuilder8.append("Unable to collect necessary methods for class ");
      stringBuilder8.append(classNotFoundException.getClass().getName());
      Log.e("TypefaceCompatApi26Impl", stringBuilder8.toString(), classNotFoundException);
      stringBuilder2 = null;
      stringBuilder8 = stringBuilder2;
      stringBuilder3 = stringBuilder8;
  ...
  public Typeface createFromFontInfo(Context paramContext, @Nullable CancellationSignal paramCancellationSignal, @NonNull FontsContractCompat.FontInfo[] paramArrayOfFontInfo, int paramInt) {
    ...
    boolean bool = false;
    for (byte b = 0; b < i; b++) {
      Throwable throwable = throwable2[b];
      ByteBuffer byteBuffer = (ByteBuffer)map.get(throwable.getUri());
      if (byteBuffer != null) {
        if (!addFontFromBuffer(object, byteBuffer, throwable.getTtcIndex(), throwable.getWeight(), throwable.isItalic())) {
          abortCreation(object);
          return null;
        } 
        bool = true;
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\core\graphics\TypefaceCompatApi26Impl.class
