...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
  ...
  private void smoothScrollBy(int paramInt1, int paramInt2, boolean paramBoolean) {
    if (getChildCount() == 0)
      return; 
  ...
  public void computeScroll() {
    ...
    //   268: aload_0
    //   269: iconst_1
    //   270: invokevirtual stopNestedScroll : (I)V
    //   273: return
  }
    ...
    switch (i) {
      ...
      case 2:
        ...
        if (this.mIsBeingDragged) {
          ...
          if (overScrollByCompat(0, i, 0, getScrollY(), 0, n, 0, 0, true) && !hasNestedScrollingParent(0))
            this.mVelocityTracker.clear(); 
          int i2 = getScrollY() - i1;
          int[] arrayOfInt = this.mScrollConsumed;
          arrayOfInt[1] = 0;
          dispatchNestedScroll(0, i2, 0, i - i2, this.mScrollOffset, 0, arrayOfInt);
      ...
      case 0:
        if (getChildCount() == 0)
          return false; 
        m = this.mScroller.isFinished() ^ true;
        this.mIsBeingDragged = m;
        if (m != 0) {
          ViewParent viewParent = getParent();
          if (viewParent != null)
            viewParent.requestDisallowInterceptTouchEvent(true); 
  ...
  public final void smoothScrollTo(int paramInt1, int paramInt2) {
    smoothScrollTo(paramInt1, paramInt2, false);
  }
  
  void smoothScrollTo(int paramInt1, int paramInt2, boolean paramBoolean) {
    smoothScrollBy(paramInt1 - getScrollX(), paramInt2 - getScrollY(), paramBoolean);
  }
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\core\widget\NestedScrollView.class
