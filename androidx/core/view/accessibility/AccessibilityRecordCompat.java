...
public class AccessibilityRecordCompat {
  ...
  public boolean equals(Object paramObject) {
    ...
    if (!(paramObject instanceof AccessibilityRecordCompat))
      return false; 
    AccessibilityRecordCompat accessibilityRecordCompat = (AccessibilityRecordCompat)paramObject;
    paramObject = this.mRecord;
    if (paramObject == null) {
      if (accessibilityRecordCompat.mRecord != null)
        return false; 
    } else if (!paramObject.equals(accessibilityRecordCompat.mRecord)) {
      return false;
    } 
    return true;
  }
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\core\view\accessibility\AccessibilityRecordCompat.class
