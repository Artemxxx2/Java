...
public class AccessibilityNodeInfoCompat {
  ...
  private List<CharSequence> extrasCharSequenceList(String paramString) {
    ...
    ArrayList<CharSequence> arrayList1 = this.mInfo.getExtras().getCharSequenceArrayList(paramString);
    ArrayList<CharSequence> arrayList2 = arrayList1;
    if (arrayList1 == null) {
      arrayList2 = new ArrayList();
      this.mInfo.getExtras().putCharSequenceArrayList(paramString, arrayList2);
    } 
    return arrayList2;
  }
  ...
  private List<Integer> extrasIntList(String paramString) {
    ...
    ArrayList<Integer> arrayList1 = this.mInfo.getExtras().getIntegerArrayList(paramString);
    ArrayList<Integer> arrayList2 = arrayList1;
    if (arrayList1 == null) {
      arrayList2 = new ArrayList();
      this.mInfo.getExtras().putIntegerArrayList(paramString, arrayList2);
    } 
    return arrayList2;
  }
  ...
  private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View paramView) {
    SparseArray<WeakReference<ClickableSpan>> sparseArray1 = getSpansFromViewTags(paramView);
    SparseArray<WeakReference<ClickableSpan>> sparseArray2 = sparseArray1;
    if (sparseArray1 == null) {
      sparseArray2 = new SparseArray();
      paramView.setTag(R.id.tag_accessibility_clickable_spans, sparseArray2);
    } 
    return sparseArray2;
  }
  ...
  public CharSequence getText() {
    if (hasSpans()) {
      List<Integer> list1 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_START_KEY");
      List<Integer> list2 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_END_KEY");
      List<Integer> list3 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY");
      List<Integer> list4 = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY");
      ...
      while (b < list1.size()) {
        spannableString.setSpan(new AccessibilityClickableSpanCompat(((Integer)list4.get(b)).intValue(), this, getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer)list1.get(b)).intValue(), ((Integer)list2.get(b)).intValue(), ((Integer)list3.get(b)).intValue());
        b++;
      } 
  ...
  public boolean isHeading() {
    ...
    boolean bool = getBooleanProperty(2);
    boolean bool1 = true;
    if (bool)
      return true; 
  ...
  public static class AccessibilityActionCompat {
    ...
    public boolean equals(@Nullable Object param1Object) {
      ...
      if (object == null) {
        if (((AccessibilityActionCompat)param1Object).mAction != null)
          return false; 
      } else if (!object.equals(((AccessibilityActionCompat)param1Object).mAction)) {
        return false;
      } 
      return true;
    }
  ...
  public static final class TouchDelegateInfoCompat {
    ...
    TouchDelegateInfoCompat(@NonNull AccessibilityNodeInfo.TouchDelegateInfo param1TouchDelegateInfo) {
      this.mInfo = param1TouchDelegateInfo;
    }
    
    public TouchDelegateInfoCompat(@NonNull Map<Region, View> param1Map) {
      if (Build.VERSION.SDK_INT >= 29) {
    ...
    @Nullable
    public Region getRegionAt(@IntRange(from = 0L) int param1Int) {
    ...
    @Nullable
    public AccessibilityNodeInfoCompat getTargetForRegion(@NonNull Region param1Region) {
      if (Build.VERSION.SDK_INT >= 29) {
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\core\view\accessibility\AccessibilityNodeInfoCompat.class
