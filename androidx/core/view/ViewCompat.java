...
public class ViewCompat {
  ...
  public static void addOnUnhandledKeyEventListener(@NonNull View paramView, @NonNull final OnUnhandledKeyEventListenerCompat listener) {
    if (Build.VERSION.SDK_INT >= 28) {
      SimpleArrayMap simpleArrayMap1 = (SimpleArrayMap)paramView.getTag(R.id.tag_unhandled_key_listeners);
      SimpleArrayMap simpleArrayMap2 = simpleArrayMap1;
      if (simpleArrayMap1 == null) {
        simpleArrayMap2 = new SimpleArrayMap();
        paramView.setTag(R.id.tag_unhandled_key_listeners, simpleArrayMap2);
      } 
      ...
      simpleArrayMap2.put(listener, onUnhandledKeyEventListener);
  ...
  private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View paramView) {
    ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> arrayList1 = (ArrayList)paramView.getTag(R.id.tag_accessibility_actions);
    ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> arrayList2 = arrayList1;
    if (arrayList1 == null) {
      arrayList2 = new ArrayList();
      paramView.setTag(R.id.tag_accessibility_actions, arrayList2);
    } 
    return arrayList2;
  }
  ...
  private static int getAvailableActionIdFromResources(View paramView) {
    ...
    while (true) {
      ...
      if (b < arrayOfInt.length && i == -1) {
        ...
        while (b1 < list.size()) {
          byte b2;
          if (((AccessibilityNodeInfoCompat.AccessibilityActionCompat)list.get(b1)).getId() != j) {
            b2 = 1;
          } else {
            b2 = 0;
          } 
  ...
  static AccessibilityDelegateCompat getOrCreateAccessibilityDelegateCompat(@NonNull View paramView) {
    AccessibilityDelegateCompat accessibilityDelegateCompat1 = getAccessibilityDelegate(paramView);
    AccessibilityDelegateCompat accessibilityDelegateCompat2 = accessibilityDelegateCompat1;
    if (accessibilityDelegateCompat1 == null)
      accessibilityDelegateCompat2 = new AccessibilityDelegateCompat(); 
    setAccessibilityDelegate(paramView, accessibilityDelegateCompat2);
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\core\view\ViewCompat.class
