    ...
    switch (i) {
      ...
      case 5:
        ...
        if (j == 0) {
          ...
          int m = this.mTrackingEdges;
          if ((j & m) != 0)
            this.mCallback.onEdgeTouched(j & m, i); 
          break;
        } 
        if (j == 2) {
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\customview\widget\ViewDragHelper.class
