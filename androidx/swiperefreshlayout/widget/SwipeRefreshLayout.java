...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  protected int getChildDrawingOrder(int paramInt1, int paramInt2) {
    ...
    return (i < 0) ? paramInt2 : ((paramInt2 == paramInt1 - 1) ? i : ((paramInt2 >= i) ? (paramInt2 + 1) : paramInt2));
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    view.layout(paramInt3, paramInt2, paramInt1 - getPaddingLeft() - getPaddingRight() + paramInt3, paramInt4 - getPaddingTop() - getPaddingBottom() + paramInt2);
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\swiperefreshlayout\widget\SwipeRefreshLayout.class
