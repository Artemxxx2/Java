...
public class PagerTitleStrip extends ViewGroup {
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    TextView textView = this.mCurrText;
    textView.layout(m, i1, j, textView.getMeasuredHeight() + i1);
    i1 = Math.min(i2, m - this.mScaledTextSpacing - i);
    textView = this.mPrevText;
    textView.layout(i1, i4, i + i1, textView.getMeasuredHeight() + i4);
    i4 = Math.max(n - i3 - k, j + this.mScaledTextSpacing);
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\androidx\viewpager\widget\PagerTitleStrip.class
