...
public class Base64 {
  ...
  private static int decode4to3(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2, byte[] paramArrayOfbyte3) {
    ...
    if (paramArrayOfbyte1[j] == 61) {
      byte b1 = paramArrayOfbyte3[paramArrayOfbyte1[paramInt1]];
      paramInt1 = paramArrayOfbyte3[paramArrayOfbyte1[paramInt1 + 1]];
      paramInt1 = paramArrayOfbyte3[paramArrayOfbyte1[i]] << 24 >>> 18 | paramInt1 << 24 >>> 12 | b1 << 24 >>> 6;
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\com\alexdisler\inapppurchases\Base64.class
