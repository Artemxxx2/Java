...
public class Builder {
  ...
  @NonNull
  public Builder setObfuscatedAccountId(@NonNull String paramString) {
    this.zza = paramString;
    return this;
  }
  
  @NonNull
  public Builder setObfuscatedProfileId(@NonNull String paramString) {
  ...
  @NonNull
  @zzj
  public Builder setProductDetailsParamsList(@NonNull List<BillingFlowParams.ProductDetailsParams> paramList) {
    this.zzc = new ArrayList<BillingFlowParams.ProductDetailsParams>(paramList);
    return this;
  }
  ...
  public Builder setSkuDetails(@NonNull SkuDetails paramSkuDetails) {
    ...
    arrayList.add(paramSkuDetails);
    this.zzd = arrayList;
    return this;
  }
  
  @NonNull
  public Builder setSubscriptionUpdateParams(@NonNull BillingFlowParams.SubscriptionUpdateParams paramSubscriptionUpdateParams) {
...
/* Location:              C:\Users\Root1\Desktop\Stash\output\!\com\android\billingclient\api\BillingFlowParams$Builder.class
